...
function NavbarRight() {
    return (
        <nav>
            <ul className="flex items-center text-[#222222] px-6">
                <li>
                ...
                <li className="p-2 pl-3 text-gray-500 border rounded-full">
                    <a href="/contact" className="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
                            <g>
